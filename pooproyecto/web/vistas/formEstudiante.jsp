                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown user user-menu">
                                ...
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    ...
                                    <span class="hidden-xs">${estudiante.nombreUsuario}</span>
                                </a>
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="user-header">
                                        ...
                                        <p>                    
                                            BIENVENIDO  - ${estudiante.nombreUsuario} <br><br>
                                            ROL: ${estudiante.cargo.nombreCargo} 
                                        </p>
                                    </li>
                                    <!-- Menu Footer-->
            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu" data-widget="tree">
                        ...
                        <li class="active"><a href="#"><i class="fa fa-link"></i> <span>Panel Estudiante</span></a></li>
                        <li class="treeview">
