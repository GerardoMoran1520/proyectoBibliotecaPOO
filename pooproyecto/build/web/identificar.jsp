...
<head>
  ...
  <title>Biblioteca | Iniciar Sesion</title>
...
<div class="login-box">
  <div class="login-logo">
      <a href="#"><b>BIBLIOTECA  </b><br>Amigos De Don Bosco</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <div class="social-auth-links text-center">
      ...
      <a href="#" class="btn btn-block btn-social btn-info btn-flat"><i class="fa fa-info"></i> Mensaje: 
        ${msje}</a>
    </div>
    <!-- /.social-auth-links -->
