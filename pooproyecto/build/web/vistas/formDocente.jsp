<%-- 
    ...
    Created on : 11-29-2023, 08:45:42 PM
    Author     : drago
--%>
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown user user-menu">
                                ...
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    ...
                                    <span class="hidden-xs">${docente.nombreUsuario}</span>
                                </a>
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="user-header">
                                        ...
                                        <p>                    
                                            BIENVENIDO  - ${docente.nombreUsuario} <br><br>
                                            ROL: ${docente.cargo.nombreCargo} 
                                        </p>
                                    </li>
                                    <!-- Menu Footer-->
            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu" data-widget="tree">
                        ...
                        <li class="active"><a href="#"><i class="fa fa-link"></i> <span>Panel Docente </span></a></li>
                        <li class="treeview">
                            <a href="#"><i class="fa fa-cart-arrow-down"></i> <span>Documento</span>
                                <span class="pull-right-container">
                                    <i class="fa fa-angle-left pull-right"></i>
                                </span>
                            </a>
                            <ul class="treeview-menu">
                                <li><a href="#"><i class="fa fa-cart-arrow-down"></i>Prestamo</a></li>
                                <li><a href="#"><i class="fa fa-tags"></i>Devolución</a></li>
                            </ul>
                        </li>
                    </ul>
                    <!-- /.sidebar-menu -->
